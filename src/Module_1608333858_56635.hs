...
module Module_1608333858_56635 where
...
decodeRules4 :: String -> State (Integer,Integer,Char) ()
decodeRules4 = mapM_ (modify . rules) . decodeRules
...
-- >>> start &~ decodeRules4 smallInput & displacement
-- 25
