...
souffle::RelationWrapper<t_btree_ii__0_1__11> wrapper_rel_3_edge;
// -- Table: reachable
Own<t_btree_ii__0_1__11> rel_4_reachable = mk<t_btree_ii__0_1__11>();
souffle::RelationWrapper<t_btree_ii__0_1__11> wrapper_rel_4_reachable;
public:
Sf_path()
: wrapper_rel_3_edge(0, *rel_3_edge, *this, "edge", std::array<const char *,2>{{"s:symbol","s:symbol"}}, std::array<const char *,2>{{"n","m"}}, 0)
, wrapper_rel_4_reachable(1, *rel_4_reachable, *this, "reachable", std::array<const char *,2>{{"s:symbol","s:symbol"}}, std::array<const char *,2>{{"n","m"}}, 0)
{
...
in file /Users/lyndon/code/haskellplay/src/souffle-experiments/test.dl [11:1-11:16])_");
[&](){
...
();signalHandler->setMsg(R"_(edge("c","e").
in file /Users/lyndon/code/haskellplay/src/souffle-experiments/test.dl [13:1-13:16])_");
[&](){
CREATE_OP_CONTEXT(rel_3_edge_op_ctxt,rel_3_edge->createContext());
...
in file /Users/lyndon/code/haskellplay/src/souffle-experiments/test.dl [12:1-12:16])_");
[&](){
CREATE_OP_CONTEXT(rel_3_edge_op_ctxt,rel_3_edge->createContext());
Tuple<RamDomain,2> tuple{{ramBitCast(RamSigned(1)),ramBitCast(RamSigned(2))}};
rel_3_edge->insert(tuple,READ_OP_CONTEXT(rel_3_edge_op_ctxt));
}
();signalHandler->setMsg(R"_(edge("e","f").
in file /Users/lyndon/code/haskellplay/src/souffle-experiments/test.dl [14:1-14:16])_");
[&](){
CREATE_OP_CONTEXT(rel_3_edge_op_ctxt,rel_3_edge->createContext());
Tuple<RamDomain,2> tuple{{ramBitCast(RamSigned(3)),ramBitCast(RamSigned(4))}};
rel_3_edge->insert(tuple,READ_OP_CONTEXT(rel_3_edge_op_ctxt));
}
();signalHandler->setMsg(R"_(edge("c","d").
in file /Users/lyndon/code/haskellplay/src/souffle-experiments/test.dl [15:1-15:16])_");
[&](){
CREATE_OP_CONTEXT(rel_3_edge_op_ctxt,rel_3_edge->createContext());
...
signalHandler->setMsg(R"_(reachable(x,y) :- 
   edge(x,y).
in file /Users/lyndon/code/haskellplay/src/souffle-experiments/test.dl [18:1-18:31])_");
if(!(rel_3_edge->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_3_edge_op_ctxt,rel_3_edge->createContext());
...
signalHandler->setMsg(R"_(reachable(x,z) :- 
   edge(x,y),
   reachable(y,z).
in file /Users/lyndon/code/haskellplay/src/souffle-experiments/test.dl [19:1-19:48])_");
...
{
try{
souffle::CmdOptions opt(R"(src/souffle-experiments/test.dl)",
R"()",
R"()",
false,
R"()",
