...
-- 
-- From: https://hackage.haskell.org/package/universum-1.7.2/docs/Universum-VarArg.html
...
-- Could not find module ‘Universum.Base’
...
instance (a ~ c, r ~ b) => SuperComposition (a -> b) c r where
    f ... g = f g
    {-# INLINE (...) #-}

instance (SuperComposition (a -> b) d r1, r ~ (c -> r1)) => SuperComposition (a -> b) (c -> d) r where
    (f ... g) c = f ... g c
    {-# INLINE (...) #-}
